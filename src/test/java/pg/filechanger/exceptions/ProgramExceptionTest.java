...
public class ProgramExceptionTest {
    ...
    public void setUp() throws Exception {
        msgHelper = MessageHelper.getInstance(PropertiesHelper.readBundles(Locale.forLanguageTag("PL")));
    }
    ...
    public void testProgramException_PREPARATION() throws Exception {
        ...
        assertNotNull(pe);
        assertEquals("Błąd podczas przygotowania obiektów.", msgHelper.getErrorMsg(pe.getErrorCode()));
    }
